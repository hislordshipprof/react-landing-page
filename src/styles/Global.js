const styles = {
  ...
  section1:"flex justify-start items-start p-6 sm:p-3",
  ...
  sectionImg: "w-full h-full minmd:w-11/12 minmd:h-11/12 object-contain  shadow-md",
  // sectionImg1: "w-50 h-50 minmd:w-5/6 minmd:h-5/6 object-contain",
  sectionImg1: "w-20 h-20 minlg:w-40 minlg:h-40 object-cover mb-1",
